                    ...
                    <div className="ml-8 mt-2 space-y-2">
                      {item.children.map((child) => (
                        <button
                          ...
                          className={cn(
                            "flex items-center gap-3 w-full text-sm px-3 py-2 rounded-md group transition-colors",
                            pathName === child.href
                              ? "bg-blue-600 text-white"
                              : "bg-blue-50 text-gray-800 hover:bg-blue-100 hover:text-white dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                          )}
                        >
                          <div className="h-6 w-6 flex items-center justify-center">
                            <child.icon className="h-4 w-4 transition-colors group-hover:text-white" />
                          </div>
