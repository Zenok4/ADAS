    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        async (pos) => {
          ...
          try {
            const apiKey = "YOUR_API_KEY"; // Thay API của bạn
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 space-y-6 m-6">
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            {/* Camera trước */}
            <div
              className={`h-[480px] flex flex-col rounded-xl shadow-md border overflow-hidden dark:bg-gray-800 ${
        ...
        <div className="w-64 space-y-4 m-6 relative">
          ...
          {showTemperature && <InfoCard icon={Thermometer} label="Nhiệt độ" value={temperature} />}
