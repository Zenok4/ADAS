            ...
            <MenuTemplate title={item.title}>
                ...
                <div className="flex flex-col items-center gap-3">
                  <div className="flex items-center gap-5 w-full">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-[#b0d8ff] text-sm">Âm báo, độ nhạy, hướng dẫn làn đường</p>
                    </div>
                  </div>
              ...
              {item.title === MenuData.SignRegonize.title && (
                <div className="bg-[#0a2a43] rounded-xl p-3 flex flex-col gap-3">
                  {/* Camera */}
                  <div className="flex items-center gap-3 p-2 hover:bg-[#1a4060] rounded-lg transition-colors">
              ...
              {item.title === MenuData.Introduction.title && (
                <div className="flex flex-col gap-3">
                  <Link href="/webgioithieu" className="w-full">
                    <button className="flex items-center gap-3 w-full p-2 text-left text-white hover:bg-[#1a4060] rounded-lg transition-all">
                  ...
                  <Link href="/sudung" className="w-full">
                    <button className="flex items-center gap-3 w-full p-2 text-left text-white hover:bg-[#1a4060] rounded-lg transition-all">
                  ...
                  <Link href="/chinhsachbm" className="w-full">
                    <button className="flex items-center gap-3 w-full p-2 text-left text-white hover:bg-[#1a4060] rounded-lg transition-all">
                  ...
                  <Link href="/thongtindl" className="w-full">
                    <button className="flex items-center gap-3 w-full p-2 text-left text-white hover:bg-[#1a4060] rounded-lg transition-all">
